              ...
              >
                <span
                  className={`material-symbols-outlined ${
                    isActive("/") && location.pathname === "/" ? "fill" : ""
                  }`}
                >
                  dashboard
                </span>
        ...
        <header className="hidden md:flex h-20 items-center justify-between border-b border-slate-200 bg-white/80 backdrop-blur-md px-8 sticky top-0 z-10">
          ...
          <div className="flex items-center gap-4">
            <div className="relative group">
              <input
                className="h-10 w-80 rounded-full border border-slate-200 bg-slate-50 pl-10 pr-4 text-sm font-medium text-slate-900 placeholder:text-slate-400 focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-all outline-none"
                placeholder="Search villages, schemes..."
                type="text"
              />
              <span className="material-symbols-outlined absolute left-3 top-2.5 text-lg text-slate-400 group-focus-within:text-primary-500">
                search
              </span>
            </div>
